...
export default function TopCategories({ categories }: TopCategoriesProps) {
  ...
  return (
    <div className="mt-4 p-4 border border-beige-border bg-beige-light">
      <h3 className="font-serif text-sm font-medium mb-3">Preferred Categories</h3>
          ...
          <div key={category.name} className="flex items-center gap-3">
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="font-mono text-xs text-ink-muted ml-2 whitespace-nowrap">
                  {category.count} ({category.percentage}%)
                </span>
              </div>
              <div className="h-2 bg-beige-dark rounded-sm overflow-hidden">
                <div
